 ...
 * - Strided tensor descriptors for non-contiguous tiles
 ...
 */
static inline bool overlap_bounding_box(const PTOTensorDescriptor* a, const PTOTensorDescriptor* b) {
 ...
 */
static inline bool overlap_strided_exact(const PTOTensorDescriptor* a, const PTOTensorDescriptor* b) {
    // Different base addresses never overlap
    if (a->addr != b->addr) return false;
 ...
 */
static inline bool tensors_overlap(const PTOTensorDescriptor* a, const PTOTensorDescriptor* b) {
